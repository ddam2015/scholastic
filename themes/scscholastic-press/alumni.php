...
$default_profile_img = get_site_url() . '/wp-content/themes/scscholastic-press/assets/scscholastic_profile_placeholder.jpg';
...
<section id="content" class="grid-x grid-margin-x site-main large-padding-top xlarge-padding-bottom<?php if ( $scscholastic_ad_info['go'] ) echo $scscholastic_ad_info['ad_section_class']; ?>" role="main">
