...
var scscholastic_reveal_closer_today_button = $('#reveal_close_today');
if (scscholastic_reveal_closer_today_button.length > 0) {
  scscholastic_reveal_closer_today_button.on('click', function() {
    localStorage.setItem("scscholastic_close_today", 'true');
    localStorage.setItem("scscholastic_close_today_date", new Date() );
  });
}
