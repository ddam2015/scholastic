 ...
 */
class ProductByCategoryBlockscscholastic extends Component {
	static propTypes = {
		/**
	...
	renderEditMode() {
		...
		return (
			<Placeholder
				icon="category"
				label={ __(
					'Products by Category scscholastic',
					'woocommerce'
				) }
...
export default withSpokenMessages( ProductByCategoryBlockscscholastic );
